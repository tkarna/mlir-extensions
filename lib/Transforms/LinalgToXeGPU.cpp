...
#include "imex/Utils/MatcherUtils.h"
...
static std::optional<Value> lowerGenericOp(linalg::GenericOp genericOp,
  ...
  if (structured_match::isTwoDReluOp(genericOp, /*operands=*/nullptr)) {
  ...
  if (structured_match::isTwoDAddOp(genericOp, /*operands=*/nullptr)) {
